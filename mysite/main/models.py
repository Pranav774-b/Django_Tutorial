...
class Tutorial(models.Model):
    ...
    tutorial_slug= models.CharField(max_length=200, default="")

    def __str__(self):
        return self.tutorial_title
    #These two lines help us give the tutorial string name. Else the tutorial will be shown as tutorial1 and 2
